...
html_context = {
    ...
    "github_repo": "tencirchem",  # Repo name
    "github_version": "master",  # Version
    "conf_py_path": "/source/",  # Path in the checkout to the docs root
}

html_logo = "statics/logov0.png"
html_favicon = "statics/favicon.ico"

# -- Options for HTMLHelp output ---------------------------------------------

# Output file base name for HTML help builder.
htmlhelp_basename = "tencirchemdoc"
...
man_pages = [(master_doc, "tencirchem", "TenCirChem Documentation", [author], 1)]
